...
library MulDivMath {
    ...
    function mulDivFloor(uint256 a, uint256 b, uint256 c) internal pure returns (uint256 res) {
    ...
    function mulDivCeil(uint256 a, uint256 b, uint256 c) internal pure returns (uint256 res) {
