...
import {IButterMintCallback} from "./butter/callbacks/IButterMintCallback.sol";
import {IButterSwapCallback} from "./butter/callbacks/IButterSwapCallback.sol";

interface IRangeProtocolVault is IButterMintCallback, IButterSwapCallback {
    event Minted(
